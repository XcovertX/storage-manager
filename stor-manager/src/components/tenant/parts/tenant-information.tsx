...
import DemandTypeSelector from "@/components/inputs/demand-selector";
import GateAccess from "@/components/inputs/gate-access";

type Props = {
  unit?: Unit
}

function CustomerInformation({ unit }: Props) {
